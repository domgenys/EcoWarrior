...
import com.example.Eco_warrior.classifier.ImageClassifier;

/**
 * The Chhose option  Class
 * <p>
 * RETRIEVED FROM INTERNET retrieved from https://blog.notyouraveragedev.in/android/image-classification-in-android-using-tensor-flow/
 */
public class ChooseOption extends AppCompatActivity {
    ...
    public static final int CAMERA_REQEUST_CODE = 10001;
